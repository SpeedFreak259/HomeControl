...
// required string message = 3;
inline bool DimmerCommand::has_message() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void DimmerCommand::set_has_message() {
  _has_bits_[0] |= 0x00000004u;
}
inline void DimmerCommand::clear_has_message() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void DimmerCommand::clear_message() {
  if (message_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    message_->clear();
  }
  clear_has_message();
}
inline const ::std::string& DimmerCommand::message() const {
  // @@protoc_insertion_point(field_get:homeControl.DimmerCommand.message)
  return *message_;
}
inline void DimmerCommand::set_message(const ::std::string& value) {
  set_has_message();
  if (message_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    message_ = new ::std::string;
  }
  message_->assign(value);
  // @@protoc_insertion_point(field_set:homeControl.DimmerCommand.message)
}
inline void DimmerCommand::set_message(const char* value) {
  set_has_message();
  if (message_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    message_ = new ::std::string;
  }
  message_->assign(value);
  // @@protoc_insertion_point(field_set_char:homeControl.DimmerCommand.message)
}
inline void DimmerCommand::set_message(const char* value, size_t size) {
  set_has_message();
  if (message_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    message_ = new ::std::string;
  }
  message_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:homeControl.DimmerCommand.message)
}
inline ::std::string* DimmerCommand::mutable_message() {
  set_has_message();
  if (message_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    message_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:homeControl.DimmerCommand.message)
  return message_;
}
inline ::std::string* DimmerCommand::release_message() {
  clear_has_message();
  if (message_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void DimmerCommand::set_allocated_message(::std::string* message) {
  if (message_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete message_;
  }
  if (message) {
  ...
  // @@protoc_insertion_point(field_set_allocated:homeControl.DimmerCommand.message)
}
